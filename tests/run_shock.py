...
def f_init(x, y, z, v):
    if (x <= 0.):
        return Boltzmann.f_maxwell(v, n_l, u_l, 0., 0., T_l, gas_params.Rg)
    else:
        return Boltzmann.f_maxwell(v, n_r, u_r, 0., 0., T_r, gas_params.Rg)

f_in = Boltzmann.f_maxwell(v, n_l, u_l, 0., 0., T_l, gas_params.Rg)
f_out = Boltzmann.f_maxwell(v, n_r, u_r, 0., 0., T_r, gas_params.Rg)
